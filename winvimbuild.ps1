...
$downloads = 
    (
        ...
        "$dltemp\NDP451-KB2858728-x86-x64-AllOS-ENU.exe"
    ),(
        "https://www.python.org/ftp/python/2.7.9/python-2.7.9.amd64.msi", 
        "$dltemp\python-2.7.9.amd64.msi"
    ),(
        "https://www.python.org/ftp/python/3.4.4/python-3.4.4.amd64.msi", 
        "$dltemp\python-3.4.4.amd64.msi"
    ),(
        ...
        "https://github.com/git-for-windows/git/releases/download/v2.7.4.windows.1/Git-2.7.4-64-bit.exe", 
...
$prereqProcesses = 
    (
        "Installing .Net Framework 4.5.1",
        "$dltemp\NDP451-KB2858728-x86-x64-AllOS-ENU.exe",
        ('/q','/norestart')
    ),(
...
$buildProcesses = 
    (
        ...
        "$env:ProgramFiles\Microsoft SDKs\Windows\v7.0\bin\SetEnv.Cmd",
        ('/x64')
    ),(
        "Setting MSVC++ Environment Variables",
